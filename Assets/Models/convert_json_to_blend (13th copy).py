...
def create_truncated_circle_quadrant_ceiling(x, y, radius, collection, quadrant=1, ceiling_material=None, room_ceiling_height=2.5, fixed_height=1.0):
    """
    Creates a truncated pyramid ceiling for a circle quadrant with inward-facing normals and a central 1x1 flat square for small rooms.
    ...
    # Check if room size is 3x3 (special case)
    is_small_room = radius == 1.0
    ...
    if is_small_room:
        ...
        # For larger rooms, create a full truncated pyramid top
