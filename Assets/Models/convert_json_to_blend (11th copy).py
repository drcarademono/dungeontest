...
def create_truncated_circle_quadrant_ceiling(x, y, radius, collection, quadrant=1, ceiling_material=None, room_ceiling_height=2.5, fixed_height=0.5):
    """
    ...
    # Create top vertices (scaled inward and elevated by the fixed height)
    ...
    # Add UVs with correct orientation
...
def create_rotunda_plus_ceiling(x, y, w, h, ceiling_material, ceiling_height):
    ...
    for i in range(w):
        ...
        if i == 0:  # Westmost square
            ...
            verts = [
                (start_x, center_y - 0.5, base_height + 1),  # Raised by 1
    ...
    for j in range(h):
        ...
        if j == 0:  # Southmost square
            ...
            verts = [
                (center_x - 0.5, start_y, base_height + 1),  # Raised by 1
